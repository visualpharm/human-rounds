...
1. patient safety and access;
2. institutional authority over clinical records and policy;
3. professional review of clinical suggestions;
4. privacy and data minimisation;
5. interoperability with existing public systems;
6. reusable public value.
